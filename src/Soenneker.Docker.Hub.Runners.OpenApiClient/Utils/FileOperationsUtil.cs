...
using Soenneker.Docker.Hub.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Docker.Hub.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Hub:ClientGenerationUrl"] ?? "https://docs.docker.com/reference/api/hub/latest.yaml";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Hub OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "DockerHubOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
